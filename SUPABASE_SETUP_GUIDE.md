...
CREATE INDEX idx_reviews_sitter_id ON reviews(sitter_id);
CREATE INDEX idx_earnings_sitter_id ON earnings(sitter_id);
CREATE INDEX idx_documents_user_id ON documents(user_id);
CREATE INDEX idx_availability_sitter_id ON availability(sitter_id);
```
